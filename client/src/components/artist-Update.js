...
const CreateArtist = () => {
    ...
    <form onSubmit={submitArtist}>
        <div className="form-group">
            ...
            <input type="text" className="form-control" id="artistname" aria-describedby="artistNameHelp" placeholder="Enter Name" name="artistName" onChange={updateArtist}></input>
        </div>
        <div className="form-group">
            <label htmlFor="artistLocation">Location (City, State):</label>
            <input type="text" className="form-control" id="bandLocation" aria-describedby="artistLocation" placeholder="Enter Location" name="artistLocation" onChange={updateArtist}></input>
        </div>
        <div className="form-group">
